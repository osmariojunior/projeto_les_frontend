...
const focused = "w-full font-thin uppercase flex items-center \
  p-4 my-2 transition-colors duration-200 justify-start dark:from-gray-700 dark:to-gray-800 \
  text-blue-500 bg-gradient-to-r from-white \
  to-blue-100 border-r-4 border-blue-500 border-r-4"

  const unfocused = "w-full font-thin uppercase text-gray-500 dark:text-gray-200 \
  flex items-center p-4 my-2 transition-colors duration-200 justify-start \
  hover:text-blue-500"
                ...
                <nav className="mt-6">
                    <div>
                      {console.log(window.location.pathname)}
                        <a className={window.location.pathname == "/" ? focused : unfocused} href="/">
                        ...
                        <a
                          className={window.location.pathname == "/vagas" ? focused : unfocused}
                          href="/vagas"
                          >
                            <span className="text-left">
